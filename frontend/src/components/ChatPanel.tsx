    ...
    <section className="rounded-[2rem] border border-white/10 bg-white/[0.04] p-5 backdrop-blur">
      ...
      <div className="mt-4 flex flex-col gap-3">
        <textarea
          ...
          className="min-h-24 rounded-[1.5rem] border border-white/10 bg-black/15 px-4 py-3 text-sm text-white outline-none placeholder:text-slate-500 focus:border-gold/40"
        />
        <button
          type="button"
      ...
      {result ? (
        <div className="mt-5 rounded-[1.5rem] border border-white/10 bg-black/15 p-4 lg:max-h-[calc(100vh-24rem)] lg:overflow-y-auto">
