...
If your answer contains  a series of events format it as a JSON list where each entry is a json object with the following keys: time(time of event), title and body
).
